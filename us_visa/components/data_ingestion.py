...
class DataIngestion:
    ...
    def export_data_info_feature_store(self) -> DataFrame:
        ...
        Output : data is returned as artifact of data ingestion componenrs
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        logging.info("Entered initiate_data_ingestion methos of Data_Ingestion class")
